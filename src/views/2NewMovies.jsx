  ...
  return <>
    <Box p={3}>
      <Grid>
        ...
        <MoviesComponent type={"now_playing"}/>
      </Grid>
      <Footer/>
    </Box>
  </>
...
// import MoviesComponet from "../components/MoviesComponent";
...
// <Grid>
//   {
//      movies.length == 0 ?  <CircularProgress/> : movies.map(({id, poster_path, title, original_title, release_date, type})=> <MoviesComponet
//      key={id}
//      id={id} 
